...
abstract class SwaggerModelsGenerator extends SwaggerGeneratorBase {
  ...
  String generateFlexibleJsonKeyArgumentsForType(
    String typeName, {
    bool isList = false,
  }) {
    if (typeName.isEmpty) {
    ...
    switch (normalizedType) {
      ...
      case 'num':
        return isList
            ? ', fromJson: JsonCoerce.asNumList'
            : ', fromJson: JsonCoerce.asNum';
      case 'bool':
        return isList
            ? ', fromJson: JsonCoerce.asBoolList'
            : ', fromJson: JsonCoerce.asBool';
      case 'String':
        return isList
...
''';
  ...
  String generatePropertyContentByDefault({
    ...
    final flexibleJsonKeyValue = generateFlexibleJsonKeyArgumentsForType(
      typeName,
    );
